...
public class SwaggerConfig {
	...
	.basePackage("com.blogpessoal.blogpessoal.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal Jessica")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("http://localhost:8080/swagger-ui/")
				.contact(contact()).build();
	}
	
	private static Contact contact() {
		return new Contact("Jessica Toyota", "https://github.com/jeytoyota", "jeytoyota@gmail.com");
	}
